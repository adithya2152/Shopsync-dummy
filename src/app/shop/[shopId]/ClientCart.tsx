              ...
              <CardActions>
                {quantity > 0 ? (
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <Button size="small" onClick={() => removeFromCart(product.id)} variant="outlined">
                      -
                    </Button>
                    <Typography>{quantity}</Typography>
                    <Button size="small" onClick={() => addToCart(product)} variant="outlined">
                      +
                    </Button>
                  </div>
                ) : (
                  <Button size="small" disabled={product.stock <= 0} onClick={() => addToCart(product)} variant="contained">
