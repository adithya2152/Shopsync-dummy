...
const handleGoogleSignIn = async (e: React.MouseEvent<HTMLButtonElement>) => {
   try {
      ...
      window.location.href = url; // Important: Use window.location
    } catch (error) {
...
//             <button onClick={handleOpenDialog} disabled={isRegisterDisabled}>
//               Register
//             </button>
//             <p>
//               Already have Account? <a href="/login">Signup</a>
//             </p>
//           </form>
//           <Toaster />
//         </div>
