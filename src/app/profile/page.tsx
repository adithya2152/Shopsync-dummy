                            ...
                            <Box key={address.id} sx={{ mb: 3, p: 2, border: '1px solid', borderRadius: 2, position: 'relative' }}>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <TextField fullWidth label="House Number" value={address.house_number} onChange={(e) => handleFieldChange('address', index, 'house_number', e.target.value)} disabled={!isEditing} />
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField fullWidth label="Street Address" value={address.street_address} onChange={(e) => handleFieldChange('address', index, 'street_address', e.target.value)} disabled={!isEditing} />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField fullWidth label="Address Line 2" value={address.address_line2} onChange={(e) => handleFieldChange('address', index, 'address_line2', e.target.value)} disabled={!isEditing} />
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField fullWidth label="City" value={address.city} onChange={(e) => handleFieldChange('address', index, 'city', e.target.value)} disabled={!isEditing} />
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
