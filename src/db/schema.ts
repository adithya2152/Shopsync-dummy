...
import { serial, uuid, pgTable, varchar, json, integer, timestamp, numeric , date ,text, primaryKey } from "drizzle-orm/pg-core";
...
export const ShopSync_Users = pgTable("ShopSync_Users", {
    ...
    homeLoc: json("homeLoc").notNull(), // Stores { latitude, longitude , houseNo , street Address ,AdressLine2 , city ,  pincode }
